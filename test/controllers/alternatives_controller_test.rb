...
class AlternativesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alternative" do
    assert_difference('Alternative.count') do
      post alternatives_url, params: { alternative: { correta: @alternative.correta, enunciado: @alternative.enunciado } }
    end
  ...
  test "should update alternative" do
    patch alternative_url(@alternative), params: { alternative: { correta: @alternative.correta, enunciado: @alternative.enunciado } }
